			  ...
			  <div class="panel-body">
				<form role="form" action="${PATH }/admin/doAdd" id="addForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="exampleInputPassword1" name="loginacct" placeholder="请输入登陆账号(注册后不可更改，请谨慎填写)">
				  </div>
				  <div class="form-group">
				  ...
				  <button id="addBut" type="button" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 新增</button>
